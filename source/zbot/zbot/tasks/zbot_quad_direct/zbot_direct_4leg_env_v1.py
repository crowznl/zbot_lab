...
class Zbot4LEnvV1(DirectRLEnv):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        # print("目标关节位置:", self._processed_actions)
        # self.save_tensor_to_csv(self._processed_actions, env_id=0, csv_file_path="logs/csv/4L/processed_actions_env0.csv")
    ...
    def _get_observations(self) -> dict:
        ...
        # print("当前关节位置:", self._robot.data.joint_pos)
        # print("初始关节位置:", self._robot.data.default_joint_pos)
        # self.save_tensor_to_csv(obs, env_id=0,csv_file_path="logs/csv/4L/obs_env0.csv")
        # print(obs.shape)
    ...
    def save_tensor_to_csv(self, var: torch.Tensor, env_id: int = 0, csv_file_path: str = "xxx_env0.csv"):
        """
        ...
        with open(csv_file_path, mode='a', newline='') as file:
            ...
            row = [current_time] + var[env_id].cpu().tolist()
            writer.writerow(row)
