...
class Zbot6BFlatEnvCfg(Zbot6BRoughEnvCfg):
    def __post_init__(self):
        ...
        # self.rewards.foot_forward.weight = 0.5
        ...
        # # self.rewards.foot_forward = None
        ...
        # # self.rewards.base_vel_forward.params["which_forward"] = -1
        ...
        # self.rewards.feet_slide.weight = -6.5
        # self.rewards.feet_clearance = None
        # self.rewards.feet_air_time = None
        # # self.rewards.air_time_variance = None
        # self.rewards.air_time_variance.weight = -15.0
        # # self.rewards.base_vel_forward = None
        # self.rewards.feet_force_pattern = None
        # self.rewards.undesired_contacts = None
        ...
        # self.rewards.foot_step_length = None
        self.rewards.foot_step_length.weight = 5.0
        # self.rewards.foot_step_length.params["command_name"] = "base_velocity"
        # self.rewards.foot_downward = None
        # self.rewards.foot_forward = None
        self.rewards.gait = None
        # self.rewards.feet_slide = None
