...
# try to lie down
# 注意
# self._contact_sensor.find_bodies 和self._robot.find_bodies 获得的body_idx是不一样的！！！
...
class ZbotDirectEnvV2V2(DirectRLEnv):
    cfg: ZbotDirectEnvCfgV2V2

    def __init__(self, cfg: ZbotDirectEnvCfgV2V2, render_mode: str | None = None, **kwargs):
