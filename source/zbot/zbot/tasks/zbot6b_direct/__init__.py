...
from .zbot_direct_6dof_bipedal_env_v2_1_1 import ZbotDirectEnvCfgV2V1_1, ZbotDirectEnvV2V1_1 # curriculum learning
...
gym.register(
    id="zbot-6b-walking-v2-1-1",
    entry_point="zbot.tasks.zbot6b_direct:ZbotDirectEnvV2V1_1",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": ZbotDirectEnvCfgV2V1_1,
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PPORunnerCfgV2V1",
    },
)
...
gym.register(
    id="zbot-6b-walking-v4",
    entry_point="zbot.tasks.zbot6b_direct:Zbot6SEnvV4",
    disable_env_checker=True,
    kwargs={
