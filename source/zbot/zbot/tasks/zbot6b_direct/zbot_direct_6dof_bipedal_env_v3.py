...
from zbot.assets import ZBOT_6S_1_CFG

@configclass
class ZbotDirectEnvCfgV3(DirectRLEnvCfg):
    # robot
    robot: ArticulationCfg = ZBOT_6S_1_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
class ZbotDirectEnvV3(DirectRLEnv):
    cfg: ZbotDirectEnvCfgV3

    def __init__(self, cfg: ZbotDirectEnvCfgV3, render_mode: str | None = None, **kwargs):
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        # print(self.base_pos_w[:2, 2])  # [0.2120, 0.2120]
        # print(self._robot.data.body_link_pos_w[0, 12, 1] - self._terrain.env_origins[0,1])  # 0.3872
