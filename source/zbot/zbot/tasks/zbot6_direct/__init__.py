...
from .zbot_direct_6dof_snake_v1 import Zbot6SnakeEnvV1, Zbot6SnakeEnvV1Cfg
...
gym.register(
    id="zbot-6s-snake-v1",
    entry_point="zbot.tasks.zbot6_direct:Zbot6SnakeEnvV1",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": Zbot6SnakeEnvV1Cfg,
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PPORunnerCfgV1",
    },
)
