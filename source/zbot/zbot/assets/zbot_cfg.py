...
robot_6s_usd_v2 = "zbot_6s_v09.usd"  # rotate base 64 degree to make initial root quaternion 1,0,0,0
...
robot_6_node_usd_v2 = "zbot_6s_v07.usd"  # recreate articulation root at base
robot_12_node_usd = "zbot_12s_v00.usd"

robot_8_usd = "zbot_8s_v0.usd"  # very old version
robot_8s_usd = "zbot_8s_new.usd"  # with base node
...
robot_quadruped_usd = "zbot_4leg_v01.usd"
...
ZBOT_6S_CFG_1 = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            "joint1": 0.0,
            "joint2": 0.0,
            "joint3": -3.141593,  # -180 degrees
            "joint4": 3.141593,  # 这里保留正值，是因为ZBOT_6S_CFG里为正，如果想在之前的训练上resume，防止策略输入上的突变，暂时是这么考虑的。
            "joint5": 0.0,
            "joint6": 0.0,
        },
        joint_vel={
...
ZBOT_6S_CFG_2 = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.05),
        # rot=(1.0, 0.0, 0.0, 0.0),
        rot=(0.707, 0.0, -0.707, 0.0),  # (w, x, y, z); y-axis -90;
        joint_pos={
            "joint[1-6]": 0.0,
        },
        joint_vel={
...
ZBOT_12S_1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=usd_dir_path + robot_12_node_usd,
        activate_contact_sensors=True,  # True
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
ZBOT_6S_V2_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=usd_dir_path + robot_6s_usd_v2,
        activate_contact_sensors=True,  # True
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
ZBOT_4L_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=usd_dir_path + robot_quadruped_usd,
        activate_contact_sensors=True,  # True
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
ZBOT_8S_CFG = ArticulationCfg(
    # prim_path="{ENV_REGEX_NS}/Robot",
    spawn=sim_utils.UsdFileCfg(
        usd_path=usd_dir_path + robot_8s_usd,
        activate_contact_sensors=True,  # True
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
